...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE repartidor SET nombre_repart=?, primer_apellido=?, segundo_apellido=?, email=?, contraseña=?, telefono=?, domicilio=? WHERE id_repartidor=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssssi", $param_name, $param_p_apellido, $param_s_apellido, $param_email, $param_contraseña, $param_address, $param_salary, $param_id_repartidor);
            ...
            $param_id_repartidor = $id_repartidor;
