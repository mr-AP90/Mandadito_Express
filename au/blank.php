            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="repartidor.php"
                                aria-expanded="false">
                                <i class="fa-solid fa-motorcycle"></i>
                                <span class="hide-menu">Repartidor</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="vehiculos.php"
                                aria-expanded="false">
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="container-fluid">
                ...
                <div class="page-header clearfix">
                       <center><a href="crud-producto/leeimagen.php" class="btn btn-success pull-right">Agregar un Producto</a></center>
                    </div><br>
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        include_once "crud-producto/config.php";
                        $con = mysqli_connect($db_host, $db_user, $db_pass, $db_database);
                        $query = "SELECT id,nombre_producto,tipo,precio,descripcion,imagen FROM productos;";
