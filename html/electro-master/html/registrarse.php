					...
					enctype="multipart/form-data">
                        <div class="d-flex flex-row align-items-center mb-4"> 
                            <div class="form-outline flex-fill mb-0">
                              ...
                              <input type="text" class="form-control"  name="username" placeholder="Escribe tu nombre" id="username" required>
                            </div>
                        </div>
                        <br>
                        <div class="d-flex flex-row align-items-center mb-4"> 
                            <div class="form-outline flex-fill mb-0">
                            	<label class="form-label">Ingresa tu primer apellido:</label>
                              <input type="text" class="form-control"  name="primer_apellido" placeholder="Ingresa tu primer apellido:" id="primer_apellido" required>
                            </div>
                        </div>
                        <br>
                        <div class="d-flex flex-row align-items-center mb-4"> 
                            <div class="form-outline flex-fill mb-0">
                            	<label class="form-label">Ingresa tu segundo apellido:</label>
                              <input type="text" class="form-control"  name="segundo_apellido" placeholder="Ingresa tu segundo apellido:" id="segundo_apellido" required>
                            </div>
                        </div>
                        <br>                        
                         <div class="d-flex flex-row align-items-center mb-4"> 
                        ...
                        div class="form-group">
						   	  		<label for="exampleFormControlFile1">Subir foto
						   	  		o INE/IFE:</label>
