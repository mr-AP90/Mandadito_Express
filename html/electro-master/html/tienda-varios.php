				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li><a href="tienda.php">Varios</a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Varios-1">
									<label for="Varios-1">
										<span></span>
										Farmacia
										<small>(6)</small>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Varios-2">
									<label for="Varios-2">
										<span></span>
										aceo
										<small>(3)</small>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Varios-3">
									<label for="Varios-3">
										<span></span>
										Regalos
										<small>(6)</small>
						...
						<div class="aside">
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="../img/varios/prod-varios10.jpg" alt="">
								</div>
								<div class="product-body">
									<p class="product-Varios">Varios</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="../img/varios/prod-varios11.jpg" alt="">
								</div>
								<div class="product-body">
									<p class="product-Varios">Varios</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="../img/varios/prod-varios12.jpg" alt="">
								</div>
								<div class="product-body">
									<p class="product-Varios">Varios</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios01.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios02.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios03.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios04.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios05.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios06.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios07.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios08.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/varios/prod-varios09.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Varios">Varios</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
