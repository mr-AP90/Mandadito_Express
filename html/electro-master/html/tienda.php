					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Restaurante-1">
									<label for="Restaurante-1">
										<span></span>
										Comida
										<small>(5)</small>
									</label>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Restaurante-2">
									<label for="Restaurante-2">
										<span></span>
										Bebidas
										<small>(3)</small>
									</label>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="Restaurante-3">
									<label for="Restaurante-3">
										<span></span>
										Postres
										<small>(4)</small>
									</label>
						...
						<div class="aside">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-Restaurante">Restaurante</p>
									<h3 class="product-name"><a href="product-tienda/prod-laclinica02.php">product name goes here</a></h3>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/inico/michez01.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Restaurante">Restaurante</p>
										<h3 class="product-name"><a href="product-tienda/prod-mzancas01.php">product name goes here</a></h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/inico/michez02.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Restaurante">Restaurante</p>
										<h3 class="product-name"><a href="product-tienda/prod-mzancas02.php">product name goes here</a></h3>
										<h4 class="product-price">$85.00 </h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../img/inico/michez03.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-Restaurante">Restaurante</p>
										<h3 class="product-name"><a href="product-tienda/prod-mzancas03.php">product name goes here</a></h3>
