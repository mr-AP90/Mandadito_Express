<?php
                if (isset($_REQUEST['login'])) {
                    ...
                    $sql = "SELECT id_administrador,email,contraseña from administrador where email='$user' and contraseña='$pass'; ";
                    ...
                    if ($row) {
                        ...
                        $_SESSION['activo'] = '1';
                        header("Location: ../../../../au/dashboard.php");
                    } else {
                ?>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Inicio de sesión Admin</h3>
			      		</div>
								<div class="w-100">
			...
			<div class="section">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								<h3 class="footer-title">Usuario Administrador</h3>
								<ul class="footer-links">
