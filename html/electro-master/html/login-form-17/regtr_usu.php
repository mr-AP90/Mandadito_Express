<?php
                if (isset($_REQUEST['login'])) {
                    ...
                    $sql = "SELECT id_cliente,correo,contraseña from clientes where correo='$user' and contraseña='$pass'; ";
                    ...
                    if ($row) {
                        ...
                        $_SESSION['activo'] = '1';
                        header("Location: ../inicio-producto.php");
                    } else {
                ?>
                        <div class="alert alert-danger" role="alert">
                            <strong>Correo y contraseña no validos</strong>
                        </div>
                <?php
                    }
                }
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Inicio de sesión Cliente</h3>
			      		</div>
								<div class="w-100">
			...
			<div class="section">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								<h3 class="footer-title">Usuario Cliente</h3>
								<ul class="footer-links">
									<li><a href="regtr_admin.php">Administrador</a></li>
									<li><a href="regtr_repa.php">Repartidor</a></li>
								</ul>
							</div>
						</div>
