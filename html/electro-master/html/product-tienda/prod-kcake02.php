										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img src="../../img/inico/producto01.png" alt="">
				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restaurante</p>
								<h3 class="product-name"><a href="prod-kcake01.php">product name goes here</a></h3>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restaurante</p>
								<h3 class="product-name"><a href="prod-kcake03.php">product name goes here</a></h3>
								<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
