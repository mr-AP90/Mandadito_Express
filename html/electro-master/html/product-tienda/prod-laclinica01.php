					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#">10 Reseña(s) | Añadir una reseña</a>
							</div>
							<div>
								<h3 class="product-price">$130.00 </h3>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							<div class="product-img">
								<img src="../../img/inico/laclinica01.jpg" alt="">
							</div>
							<div class="product-body">
								<p class="product-category">Restauarante</p>
								<h3 class="product-name"><a href="prod-laclinica04.php">product name goes here</a></h3>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restauarante</p>
								<h3 class="product-name"><a href="prod-laclinica02.php">product name goes here</a></h3>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restauarante</p>
								<h3 class="product-name"><a href="prod-laclinica03.php">product name goes here</a></h3>
								<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							<div class="product-img">
								<img src="../../img/inico/laclinica04.jpg" alt="">
							</div>
							<div class="product-body">
								<p class="product-category">Restauarante</p>
								<h3 class="product-name"><a href="prod-laclinica05.php">product name goes here</a></h3>
								<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
								</div>
								<div class="product-btns">
