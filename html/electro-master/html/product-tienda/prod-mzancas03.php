				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								...
								<h3 class="product-name"><a href="prod-kcake09.php">product name goes here</a></h3>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restaurante</p>
								<h3 class="product-name"><a href="prod-mzancas02.php">product name goes here</a></h3>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Restaurante</p>
								<h3 class="product-name"><a href="prod-kcake07.php">product name goes here</a></h3>
								<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
